          ...
          <div className="my-4 px-4">
            <div className="flex flex-col">
              <div className="w-full mb-4">
                {/* Skill name */}
                <TextInput title="Skill Name" id={skill.id + "-name"} initialValue={skill.title}
                  placeholder="Input skill name..."
                  onChange={(value) => onSave({ ...skill, title: value })} />
              </div>
              <div className="w-full mb-4">
                {/* Description */}
                <TextAreaInput title="Description" placeholder="Input skill's description..." id={skill.id + "-desc"} initialValue={skill.description}
