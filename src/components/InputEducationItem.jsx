...
export function InputEducationItem({ education, onSave, onRemove }) {
          ...
          <div className="my-4 px-4">
            <div className="flex flex-col">
              <div className="w-full mb-4">
                {/* Title */}
                <TextInput title="Title" id={education.id + "-title"} initialValue={education.title}
                  placeholder="ABC University"
                  onChange={(value) => onSave({ ...education, title: value })} />
              </div>
              <div className="w-full mb-4">
                {/* Subtitle */}
                <TextInput title="Subtitle" id={education.id + "-subtitle"} initialValue={education.subTitle}
                  placeholder="Bachelor of Science in Computer Science"
                  onChange={(value) => onSave({ ...education, subTitle: value })} />
              </div>
              <div className="w-full mb-4">
                {/* Work period */}
                <TextInput title="Period" id={education.id + "-period"} initialValue={education.period}
              ...
              {/* Key Points */}
              <div className="w-full mb-4">
                <label htmlFor={education.id + "-keyPoints"} className="flex items-center text-sm font-medium text-gray-700 mb-2">
