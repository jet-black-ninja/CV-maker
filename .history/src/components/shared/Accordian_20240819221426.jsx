...
function Accordian({title, expanded = false , children}){
    ...
    return (
        <div className = "relative px-4">
            <h6 className="mb-0">
                <button className ="relative flex items-center w-full p-4 font-semibold text-left transition-all ease-in border-b border-solid cursor-pointer border-slate-100 text-slate-700 rounded-1-1 group text-dark-"
            </h6>
        </div>
    )
}